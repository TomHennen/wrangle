module github.com/TomHennen/wrangle/tools/slsa-verifier

go 1.26.4

tool github.com/slsa-framework/slsa-verifier/v2/cli/slsa-verifier
...
require (
	...
	github.com/slsa-framework/slsa-verifier/v2 v2.7.1 // indirect
