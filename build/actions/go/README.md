...
- **Immutable releases aren't supported yet** — wrangle uploads the attested assets after goreleaser publishes the release, which [immutable releases](https://docs.github.com/en/code-security/concepts/supply-chain-security/immutable-releases) reject; leave them off until [#407](https://github.com/TomHennen/wrangle/issues/407) lands.
