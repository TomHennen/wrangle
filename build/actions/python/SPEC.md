...
| `provenance-artifact-name` | reusable workflow only | Name of the uploaded SLSA provenance artifact (re-exported from `slsa-github-generator`'s `provenance-download-name`). Empty on PR builds because the provenance job is gated on non-PR events. |
  ...
  workflow_call:
    ...
    outputs:
      ...
      provenance-artifact-name:
        value: ${{ jobs.provenance.outputs.provenance-download-name }}
