...
@test "python: attest and verify jobs are gated off when attestation is disabled" {
...
@test "python: publish-unattested job is the disabled-mode publish and holds only contents: write" {
